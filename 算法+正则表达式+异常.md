...
![](D:\Java总结\tup\算法\20180226113852869.png)
...
```Java
Arrays.binarySearch(arr, 81)//这个是Arrays提供的方法
```
...
public static void method1(){
    ...
    Matcher matcher = pattern.matcher(data);//匹配器
    // 4、定义一个循环开始爬取信息
    while (matcher.find()){
...
一个**replaceAll是用来替换**的，一个**split 是用来分割字符并返回一个字符串数组。**
